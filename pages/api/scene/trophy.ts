// Trigger trophy formation scene via events insert
...
export default async function handler(req: NextApiRequest, res: NextApiResponse) {
  ...
  try {
    ...
    const payload = { kind: 'trophy' as const }
    ...
    return res.status(200).json({ success: true, message: 'trophy scene enqueued' })
  } catch (e:any) {
